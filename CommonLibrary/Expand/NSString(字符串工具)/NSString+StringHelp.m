...
- (NSString *)timeInterval {
    ...
    if (interval < 1) {
        ...
        return [NSString stringWithFormat:@"今天%@",[self timeFormatterHM]];
    }else if (interval < 60*60*24*2) {
        return [NSString stringWithFormat:@"昨天%@",[self timeFormatterHM]];
    }else {
        return [self timeFormatterYMD];
    }
